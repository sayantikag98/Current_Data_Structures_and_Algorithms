...
public:
	...
	void insert_front(int val) {
		Node* n = new Node(val);  // n is a pointer
		if (head == NULL) {
			head = n;
			tail = n;
		}
...
Whenever you have a pointer then to access the attributes and the properties
using that pointer you will have to use the " -> " operator
